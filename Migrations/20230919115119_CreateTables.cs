    ...
    public partial class CreateTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesCastMembers", x => new { x.MovieId, x.MemberId });
                    table.ForeignKey(
                        name: "FK_MoviesCastMembers_CastMembers_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesCompany", x => new { x.CompanyId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_MoviesCompany_Companies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviesCompany_Movies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesCastMembers_MemberId",
                table: "MoviesCastMembers",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MoviesCompany_MovieId",
                table: "MoviesCompany",
                column: "MovieId");
        }
